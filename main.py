...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="pFedGen")
    ...
    parser.add_argument("--num_glob_iters", type=int, default=200)#Round number  for glob_iter in range(self.num_glob_iters)# num_glob_iters表示全局迭代的次数
    ...
    parser.add_argument("--times", type=int, default=3, help="running time")#iteration
